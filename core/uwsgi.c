...
static struct uwsgi_option uwsgi_base_options[] = {
	...
	{"memory-report", optional_argument, 'm', "enable memory report. 1 for basic (default), 2 for uss (Linux only)", uwsgi_opt_set_int, &uwsgi.logging_options.memory_report, 0},
